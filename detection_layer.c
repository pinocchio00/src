...
void forward_detection_layer(const detection_layer l, network_state state)
{
    ...
    if(state.train){
        ...
        *(l.cost) = pow(mag_array(l.delta, l.outputs * l.batch), 2);
        ...
        printf("old Detection Avg IOU: %f, Pos Cat: %f, All Cat: %f, Pos Obj: %f, Any Obj: %f, count: %d\n", avg_iou/count, avg_cat/count, avg_allcat/(count*l.classes), avg_obj/count, avg_anyobj/(l.batch*locations*l.n), count);

        printf("new Detection Avg IOU: %f, Avg Cat: %f, Avg All Cat: %f, Avg Obj: %f, Avg Any Obj: %f, count: %d\n", avg_iou, avg_cat, avg_allcat/(l.classes), avg_obj, avg_anyobj/(l.batch*locations*l.n), count);
